...
#    Updated: 2023/06/20 18:25:56 by kjimenez         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CLIENT_LDFLAGS		:= -L$(LIBFT_PATH)/bin -lft_stdio -lft_string -lft_stdlib
SERVER_LDFLAGS		:= -L$(LIBFT_PATH)/bin -lft_stdio -lft_string -lft_math
